...
<body class="usuarios">
    ...
    <nav class="navegacao">
        ...
        <a href="produtos.php" class="preto">voltar</a>
    </nav>
    <main class="principal">
            <form action="saveEdit_produto.php" method="POST" class="container" style="padding: 60px;">
                ...
                <div class="form-floating" style="margin-bottom: 30px;">
                    <input type="text" class="form-control" id="fornecedor" name="fornecedor" value="<?php echo $fornecedor ?>">
                ...
                <div class="form-floating" style="margin-bottom: 30px;">
                    <input type="text" class="form-control" id="id_fornecedor" name="id_fornecedor" value="<?php echo $id_fornecedor ?>">
